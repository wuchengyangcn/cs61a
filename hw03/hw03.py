...
def pingpong(n):
    ...
    if (n==0):
        ...
        return pingpong_helper(n-1)+pingpong(n-1)
...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    return count_coints_helper(change,1)


def count_coints_helper(change,smallest=None):
    if change<0:
        return 0
    elif change==0:
        return 1
    elif smallest==None or smallest>change:
        return 0
    else:
        return count_coints_helper(change-smallest,smallest)+count_coints_helper(change,next_larger_coin(smallest))
